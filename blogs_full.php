<?php
$part_page = "blogs full";

include('queries/blogs_full-queries.php');
...
<body>  
	...
	<div id="wrapper">
		...
		<div id="main_content">
			...
			<div style="font-size: 25px; width: 980px; margin: 0 auto; padding: 10px 10px 15px">
				<b>Blogs</b>
			</div>

			<!-- top half start -->
			<div style="width: 980px; margin: 0 auto; padding:10px;">
			...
			if($found > 0){						
				...
				<div class="blog_item" style='padding:10px;'>						
					...
					<div class="blog_posted" ><?php echo $blog_postedby; ?><!--, October 29, 2007 1 comment to this post--></div>
					...
					<script type="text/javascript">
						...
						var disqus_url = '<?php echo $xbase; ?>bloggers/<?php echo $sblog_id; ?>/<?php  echo seoUrl($blog_title); ?>/<?php echo trim(urlencode($blog_postedby)); ?>';
			...
			<div class="lfloat" style="width: 32%;" >
				<div style=" padding: 10px; width:300px; height: 250px; background: #ccc">
				<?php echo $ads_list['nba_BlogsFull_top_medallion']['Content']; ?>	
				</div>
