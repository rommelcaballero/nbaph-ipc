...
<?php
$results = mysql_query("select * from ads where Dimensions = '210x90' order by RAND() limit 0, 1");
$row = mysql_fetch_array($results);
?>
               <a href="<?php echo $row['Link']; ?>"><img src="ads/<?php echo $row['Image']; ?>"></a>
<?php
$results = mysql_query("select * from ads where Dimensions = '728x90' order by RAND() limit 0, 1");
$row = mysql_fetch_array($results);
?>
               <a href="<?php echo $row['Link']; ?>"><img src="ads/<?php echo $row['Image']; ?>"></a>
          </div>
    ...
    ?>
                                        <div class="pics_details pointer" onclick="carousel(<?php echo ($count + 1); ?>)">
                                           <div class="pics_actual">
                                              <img src="thumbs.php?filename=<?php echo $row['Image']; ?>&width=132&height=70">
                                           </div>
    ...
    ?>
                                        <div class="pics_details">
                                           <div class="pics_actual">
                                              <a href="<?php echo stripslashes($row['Link']); ?>"><img src="thumbs.php?filename=<?php echo $row['Thumbnail']; ?>&width=132&height=70" border="0"></a>
                                           </div>
    ...
    ?>
             ...
             <div style="float: left; width: 300px; margin-left: 10px">
                 ...
                 <div style="width: 300px; height: 250px">
					<?php
                    $results = mysql_query("select * from ads where Dimensions = '300x250' order by RAND() limit 0, 1");
                    $row = mysql_fetch_array($results);
                    ?>
                                   <a href="<?php echo $row['Link']; ?>"><img src="ads/<?php echo $row['Image']; ?>"></a>
                </div>
                   ...
                   <div style="width: 298px; border: 1px solid #d8d8d8">
                      ...
                      <div class="clear" style="padding: 10px">
                         ...
                         <div id="writer_personality_list">
                            <table>
    <?php
    $results = mysql_query("select BlogID, Blogger, BlogTitle, BlogLink, BlogExcerpt from personalitiesorder left join personalities using (Blogger) order by Position limit 0, 100");
    $last_blogger = "";
$blog_cnt = 0;
...
if (($last_blogger != $row['Blogger']) && ($blog_cnt < 2)) {
   ...
   $blogger_pic = strtolower(urlencode($row['Blogger']));
...
<?php } else { ?>
					<a href="writers_full.php?id=<?php echo $row['BlogID']; ?>"><?php echo stripslashes($row['BlogTitle']); ?></a>
<?php }  ?>
                                     </div>
...
$last_blogger = $row['Blogger'];
    ...
    ?>
                         ...
                         <div id="writer_blogger_list" style="display: none">
                            <table>
    <?php
    $results = mysql_query("select BlogID, Blogger, BlogTitle, BlogLink, BlogExcerpt from blogorder left join blog using (Blogger) order by Position limit 0, 100");
    $last_blogger = "";
	$blog_cnt = 0;
...
?>
                                        <a href="<?php echo stripslashes($row['BlogLink']); ?>" target="_blank"><?php echo stripslashes($row['BlogTitle']); ?></a>
<?php } else { ?>
					<a href="blogs_full.php?id=<?php echo $row['BlogID']; ?>"><?php echo stripslashes($row['BlogTitle']); ?></a>
<?php }  ?>
                                     </div>
...
?>
    ...
    <?php
    $results = mysql_query("select * from news order by DatePosted desc limit 0, 5");
    ...
    ?>
                ...
                <div style="width: 330px; padding: 5px 0 2px 0; background: url('images/rounded_bottom_330.png') bottom center no-repeat">
                   ...
                   <div class="cell_330">
                      <table style="width: 100%">
    <?php
    $results = mysql_query("select * from features order by FeatureID DESC limit 0, 10");
                                        ...
                                        <table cellspacing="0" cellpadding="0" style="width: 282px; height: 282px">
                                           <tr>
                                              <td style="text-align: center">
                                                 <a  title="<?php echo stripslashes($row['Caption']); ?>" href="photos.php?gallery_id=<?php echo $row['GalleryID']; ?>"><img src="resize_pic.php?file=<?php echo $filename; ?>&w=282&h=282"></a>
                                              </td>
                                           </tr>
                                        </table>
                                     </div>
    ...
    <?php
    $results = mysql_query("select * from pollquestions where PollID = '" . $poll['PollID'] . "'");
    ...
    ?>
                ...
                <div style="width: 330px; padding: 5px 0 2px 0; background: url('images/rounded_bottom_330.png') bottom center no-repeat; ">
                   ...
                   <div style="width: 328px; border: 1px solid #d8d8d8; border-bottom: 0px;  border-top: 0px; text-align: left; ">
                      ...
                      <div style="width: 327px; padding-top: 5px; ">
                            <ul class="video_list">
                   ...
                   <!-- twitter content -->
                    <div id="twitter_tab_list" class="cell_330" style="height: auto !important; min-height: 379px; height: 379px; border-top: 0px; " >
                   ...
                   <div id="facebook_tab_list" class="cell_330"   style="display:none; height: auto !important; min-height: 379px; height: 379px; border-top: 0px; " >
                       ...
                       <div id="Fbcontent" style="padding: 10px; "  >
          ...
          <div style="width: 982px; margin: 0 auto; padding: 5px 0 2px 0; background: url('images/rounded_bottom_982.png') bottom center no-repeat">
             <div class="article_header" style="background: url('images/rounded_top_982.png'); width: 952px; height: 15px">
                ...
                <div style="font-size: 14px; font-weight: bold; position: absolute; top: 10px; right: 15px">
                   <a href="startingfive.php" class="blue">VOTE NOW!</a>
                </div>
             </div>
