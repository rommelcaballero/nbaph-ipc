   ...
   <div id="main_content" >
    ...
    ?>
                                        <div class="pics_details pointer" onclick="carousel(<?php echo ($count + 1); ?>)">
                                           <div class="pics_actual">
                                              <img src="resize_crop.php?file=<?php echo $row['Image']; ?>&w=132&h=70">
                                           </div>
                         ...
                         <tr>
                            ...
                            <td style="width: 600px; background: #ccc">
                               <div class="scroll" id="video_list_highlights_gallery">
                                  <div class="pics">
    <?php
    $results = mysql_query("select * from videos where Section = 'Highlights' order by SortOrder DESC, DatePosted desc limit 0, 12");
    ...
    ?>
                               ...
                               <div class="scroll" id="video_list_top_gallery" style="display: none">
                                  <div class="pics">
    <?php
    $results = mysql_query("select * from videos where Section = 'Top Plays' order by SortOrder DESC, DatePosted desc limit 0, 12");
    ...
    ?>
                               ...
                               <div class="scroll" id="video_list_picks_gallery" style="display: none">
                                  <div class="pics">
    <?php
    $results = mysql_query("select * from videos where Section = 'Editor\'s Picks' order by SortOrder DESC, DatePosted desc limit 0, 12");
    ...
    ?>
                               ...
                               <div class="scroll" id="video_list_tv_gallery" style="display: none">
                                  <div class="pics">
    <?php
    $results = mysql_query("select * from videos where Section = 'NBA TV' order by SortOrder DESC, DatePosted desc limit 0, 12");
...
$last_blogger = $row['Blogger'];
    ...
    ?>
                      <div style="width: 318px">
                         <img src="resize_crop.php?file=<?php echo $row['Image']; ?>&w=318&h=159">
                      </div>
    ...
    ?>
                      ...
                      <div class="more_link">
                         <a href="features.php">More Features</a><br>
                      </div>
                   </div>
                   <!-- Headlines content end -->
                </div>
                         ...
                         <tr>
                            ...
                            <td style="width: 282px; padding: 0 5px">
                               <div class="scroll" id="gallery_pics" style="width: 282px; height: 282px; ">
                                ...
                                $results = mysql_query("select * from gallery order by SortOrder DESC, DateAdded desc limit 0, 1");
                                $gallery = mysql_fetch_array($results);
                                
                                $results = mysql_query("select * from galleryphotos where GalleryID = '" . mysql_real_escape_string($gallery['GalleryID']) . "'");
    ...
    ?>
                               <td rowspan="2" style="width: 105px">
                                  <img src="resize_crop.php?file=<?php echo $poll['Image']; ?>&w=100&h=100">
                               </td>
    <?php
       }
    ?>
