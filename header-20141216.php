          ...
          <ul id="global-nav-1" class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a target="_blank" href="http://china.nba.com">&#20013;&#22269;</a></li>
                ...
                <li><a target="_blank" href="http://www.nba.co.jp/">&#26085;&#26412;</a></li>
...
<div id="nbaph_header">
   ...
   <div id="nbaph_header_logo">
      <a href="index.php"><img src="imagesph/header_nba_logo.png" alt="NBA Logo" /></a>
   </div>

   <div id="nbaph_header_country"> <a href="index.php" style="color: #fff">PHILIPPINES</a> </div>
   ...
   <div id="nbaph_header_nav">
      ...
      <ul id="nbaph_header_ul_mobile">
         <li> 
            ...
            <ul class="nbaph_submenu_mobile">
               <li><a href="news-writers.php">NBA Writers</a></li>
               <li><a href="news.php">News</a></li>
               <li><a href="news-features.php">Features</a></li>
         ...
         <li> <a href="bloggers.php" class="mobilenav" datasolo="true">Blogs</a> </li>
      ...
      <ul id="nbaph_header_ul">
         <li>
            <a href="news.php"> News  <img src="imagesph/header_link_arrow.png" class="nbaph_header_nav_arrow" alt="link arrow" /></a>
         ...
         <li>
            <a href="videos.php"> Videos <img src="imagesph/header_link_arrow.png" class="nbaph_header_nav_arrow" alt="link arrow" /> </a>
         ...
         <li>
            <a href="bloggers.php"> Blog </a>
         </li>

         <li>
            <a href="http://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&amp;c=20&amp;mc=click&amp;pli=5577949&amp;PluID=0&amp;ord=[timestamp]"> Fantasy <img src="imagesph/header_link_arrow.png" class="nbaph_header_nav_arrow" alt="link arrow" /></a>
            <ul class="nbaph_submenu">
               <li><a href="http://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&amp;c=20&amp;mc=click&amp;pli=5577949&amp;PluID=0&amp;ord=[timestamp]">NBA.com/Yahoo! Sports Fantasy Basketball</a></li>
               <li><a href="http://hangtime.blogs.nba.com/category/fantasy/">Fantasy Blogs</a></li>
               <li><a href="https://twitter.com/nbafantasy">NBA Fantasy On Twitter</a></li>
         ...
         <li>
            <a href="events.php"> Events <img src="imagesph/header_link_arrow.png" class="nbaph_header_nav_arrow" alt="link arrow" /></a>
            <ul class="nbaph_submenu">
               <li><a href="events.php">LOCAL EVENTS</a></li>
               <li><a href="http://jrnba.asia/philippines/">JR. NBA</a></li>
               <li><a href="http://www.nba.com/nbafit/">NBA FIT</a></li>
...
<div id="nbaph_header_socialmedia">
...
<div id='div-gpt-ad-1410750169317-1' class="nbaph_mobilead" style='width:320px; height:50px; margin: 10px auto'>
<script type='text/javascript'>
googletag.cmd.push(function() { googletag.display('div-gpt-ad-1410750169317-1'); });
</script>
</div>
