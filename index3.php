...
$last_blogger = $row['Blogger'];
    ...
    ?>
                      <div style="width: 318px; ">
                          <img src="resize_pic.php?file=<?php echo $row['Image']?>&w=318&h=159" >
                       </div>
                                        ...
                                        <table cellspacing="0" cellpadding="0" style="width: 282px; height: 282px">
                                           <tr>
                                              <td style="text-align: center">
                                                 <a  title="<?php echo stripslashes($row['Caption']); ?>" href="photo-gallery/<?php echo $row['GalleryID']; ?>/<?php  echo seoUrl(stripslashes($gallery['GalleryName'])); ?>"><img src="resize_pic.php?file=<?php echo $filename; ?>&w=282&h=282"></a>
