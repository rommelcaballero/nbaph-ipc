...
$("div.scroll").scrollable({circular:true});
...
$("#headline_left").click(function(){
	...
	headline_count-=1;
	if(headline_count<0)headline_count=2;
...
$("#headline_right").click(function(){
	...
	$("#headline_circle_"+headline_count).prop("src","images/circle_empty.png");
	headline_count+=1;
	if(headline_count>2)headline_count=0;
	$("#headline_circle_"+headline_count).prop("src","images/circle_filled.png");
});
...
$(".headline_circle").click(function(){
	...
	$("#headline_pics").data("scrollable").seekTo(num);headline_count=num;
	$("#headline_circle_"+headline_count).prop("src","images/circle_filled.png");
});
...
$("#video_left").click(function(){
	...
	video_count-=1;
	if(video_count<0)video_count=2;
...
function post_fb_content() {
   $.post("rss.php", "", function(msg) {
      $("#Fbcontent").html(msg);
   });
}
//});