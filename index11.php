...
<head>  
    ...
    <link href="custom2/fontface.css" rel="stylesheet">
    <link href="custom2/styles.css" rel="stylesheet">
    <!-- this should changed to a minified version of jquery that they are already using on the given page-->
    <script type="text/javascript" src="custom2/jquery.cookie.js"></script>
    <script type="text/javascript" src="custom2/i18next-1.6.3.min.js"></script>
    <script type="text/javascript" src="custom2/script.js"></script>
	<script type="text/javascript" src="custom2/styles_stats.css"></script>
