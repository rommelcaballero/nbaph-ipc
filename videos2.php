	...
	<input type="submit" name="tagsubmit" value="Update Tag">
		...
		$(document).ready(function(){
			...
			function requestAds() {
				...
				adsRequest = {
					adTagUrl : "http://ad4.liverail.com/?LR_PUBLISHER_ID=30020&LR_SCHEMA=vast2-vpaid&LR_VERTICAL=Business&LR_VIDEO_AMID=ROS&LR_CONTENT=6&LR_AUTOPLAY=0&LR_TITLE=[LR_TITLE]&LR_VIDEO_ID=[BLR_VIDEO_ID]&CACHEBUSTER=[CACHEBUSTER]"
					};	
