                   ...
                   <div style="width: 672px; height: 376px; overflow: hidden">
					...
					?>
									  <div id="carousel<?php echo $count; ?>" class="carousel" style=" <?php if ($count > 1) echo "display: none"; ?>">
										 ...
										 if ($row['Source'] == "US")
											echo ' target="_blank"';
										 ?>><?php /*?><img src="<?php echo $row['Image']; ?>" ><?php */?></a>
								...
								?>
																	<div class="pics_details pointer" onclick="carousel(<?php echo ($count + 1); ?>)">
																	   <div class="pics_actual">
																		  <?php /*?><img src="resize_crop.php?file=<?php echo $cthumbs[$i]['Image']; ?>&w=132&h=70"><?php */?>
																		</div> 
                                  ...
                                  <div class="pics">
                                    ...
                                    ?>
                                                                        <div class="pics_details">
                                                                           <div class="pics_actual">
                                                                              <a href="<?php echo stripslashes($row['Link']); ?>"><?php /*?><img src="resize_crop.php?file=<?php echo $row['Thumbnail']; ?>&w=132&h=70" border="0"><?php */?></a>
                                                                           </div>
...
$last_blogger = $row['Blogger'];
    ...
    ?>
                      <div style="width: 318px; ">
                          <?php /*?><img src="resize_pic.php?file=<?php echo $row['Image']?>&w=318&h=159" ><?php */?>
                       </div>
                                  ...
                                  <div class="pics"> 
                                    ...
                                    ?>
                                        ...
                                        <div  style="width: 282px; height: 282px" >
                                            ...
                                            <a  title="<?php echo stripslashes($_SESSION['photos'][0]['Caption']); ?>" href="photo-gallery/<?php echo $_SESSION['photos'][0]['GalleryID']; ?>/<?php  echo seoUrl($_SESSION['photos'][0]['GalleryName']); ?>"><?php /*?><img src="resize_pic.php?file=<?php echo $_SESSION['photos'][0]['Filename']; ?>&w=282&h=282" id="GalleryMain" ><?php */?></a>
    ...
    ?>
                               <td rowspan="2" style="width: 105px">
                                  <?php /*?> <img src="resize_crop.php?file=<?php echo $poll['Image']?>&w=100&h=100"> <?php */?>
